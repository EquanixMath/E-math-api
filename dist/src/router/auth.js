...
import { registerStudent, registerAdmin, login, profile, logout, getPendingStudents, approveStudent, rejectStudent, getAllStudents } from '../controllers/auth.js';
import { authMiddleware, requireAdmin, requireApprovedStudent, requireApprovedUser } from '../middleware/auth.js';
const router = Router();
// =================
 ...
 * Headers: Authorization: Bearer <token>
 */
router.get('/student/dashboard', authMiddleware, requireApprovedStudent, (req, res) => {
    res.json({
 ...
 * Headers: Authorization: Bearer <token>
 */
router.get('/dashboard', authMiddleware, requireApprovedUser, (req, res) => {
